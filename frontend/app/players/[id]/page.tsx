...
function calculateSeasonStats(gameStats: GameStat[]) {
  ...
  gameStats.forEach(game => {
    ...
    totalPoints += points;
    // Parse minutes_played as it may be a string like "35"
...
export default async function PlayerPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const sortedGames = [...gameStats].sort((a, b) =>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Player Header with Hero Background */}
      <div
        ...
        <div className="flex items-start space-x-6 relative z-10">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-4xl font-bold text-gray-900 transition-colors duration-200">
                {player.full_name}
              </h1>
              {player.jersey && (
                <span
